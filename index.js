...
function getNumbersSquared(numbers) {
  ...
  let answers = [numbers[i] * numbers2[i]]
...
// ANSWER: the first one has to declare each one with its own value where as the other on find the value before it declared it in a singular object
